...
public class PasswordConstraintValidator implements ConstraintValidator<ValidPasswordAnnotation, String> {

    @Override
    public void initialize(ValidPasswordAnnotation arg0) {
    }
